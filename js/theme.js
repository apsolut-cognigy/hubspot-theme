...
// Main logic
document.querySelectorAll('.accordion-menu').forEach(function (accordionMenu) {
  accordionMenu.addEventListener('click', function (event) {
    ...
    if (!parent.classList.contains('is-expanded')) {
      ...
      document.querySelectorAll('.accordion-group').forEach(function (accordionGroup) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcognigy_hubspot_dev"] = self["webpackChunkcognigy_hubspot_dev"] || [];
